...
export const PROVIDER_TIERS = {
  ...
  ollama_local: {
    ...
    models: ['qwen2.5:3b', 'phi4', 'llama3.2:3b'],
    authType: 'bearer',
    tier: 'local',
    supportsTools: 'native', // OpenAI-compatible via Ollama
    supportsStreaming: true,
    rateLimitRpm: 999,
  },
  zhipu_official: {
...
export const PROVIDER_TASK_COMPATIBILITY = {
  ...
  web_news_query: {
    ...
    openrouter_free: 'required',
    gemini_official: 'required',
    ollama_local: 'optional', // local models may not have real-time web access
    anthropic_official: 'required',
    zhipu_official: 'required',
    groq_official: 'required',
  },
  ...
  agent_mini_react_app: {
    ...
    openrouter_free: 'required',
    gemini_official: 'required',
    ollama_local: 'optional', // 3b models may struggle with complex React
    anthropic_official: 'required',
    zhipu_official: 'required',
    groq_official: 'required',
  },
  agent_browser_open: {
    ...
    openrouter_free: 'required',
    gemini_official: 'required',
    ollama_local: 'unsupported', // computer use requires larger model
    anthropic_official: 'required',
    zhipu_official: 'required',
    groq_official: 'required',
  },
