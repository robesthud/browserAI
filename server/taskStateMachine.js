...
const COMMON = [
  ...
  'operator_status', 'operator_project_profile', 'operator_list_runbooks', 'operator_read_runbook', 'operator_update_runbook', 'operator_append_lesson', 'operator_start_mission', 'operator_list_missions', 'operator_get_mission', 'operator_finalize_code_task', 'operator_wait_code_task_ci', 'operator_auto_fix_code_task_ci', 'operator_merge_code_task_pr',
]
