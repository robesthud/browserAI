...
const COMMON = [
  ...
  'operator_status', 'operator_project_profile', 'operator_start_mission', 'operator_list_missions', 'operator_get_mission', 'operator_finalize_code_task', 'operator_wait_code_task_ci',
]
